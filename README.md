...
- API auth and managed login inputs: `AUTH_GOOGLE_CLIENT_ID`, `AUTH_APPLE_CLIENT_ID`, `COGNITO_CLIENT_ID`, `COGNITO_APPLE_SERVICES_ID`, `COGNITO_APPLE_KEY_ID`, `COGNITO_APPLE_PRIVATE_KEY`, `COGNITO_GOOGLE_CLIENT_SECRET`
