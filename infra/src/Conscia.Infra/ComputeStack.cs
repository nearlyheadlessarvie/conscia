        ...
        : base(scope, id, props)
    {
        ...
        ApiLambda = new Function(this, "ApiLambda", new FunctionProps
        {
            ...
            Environment = new Dictionary<string, string>
            {
                ...
                ["Version__Release"] = props.RuntimeSettings.VersionRelease ?? string.Empty,
                ["Version__CommitSha"] = props.RuntimeSettings.VersionCommitSha ?? string.Empty,
                ["Version__DeployedAt"] = props.RuntimeSettings.VersionDeployedAt ?? string.Empty,
